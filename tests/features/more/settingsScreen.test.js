...
describe('Settings Screen & Sign Out Functionality', () => {
    ...
    test('openSettingsModal displays Guest Local Mode, Login button, Achievements card, version 1.3.0, and no bottom close button', () => {
        state.userAuthId = null;
        openSettingsModal();
        ...
        expect(content.innerHTML).toContain('Version 1.3.0');
