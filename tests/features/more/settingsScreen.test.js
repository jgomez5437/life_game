...
describe('Settings Screen & Sign Out Functionality', () => {
    ...
    test('openSettingsModal displays Guest Local Mode, Login button, version 1.2.1, and no bottom close button', () => {
        state.userAuthId = null;
        openSettingsModal();
        ...
        expect(content.innerHTML).toContain('Version 1.2.1');
