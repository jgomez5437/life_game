...
describe('Settings Screen & Sign Out Functionality', () => {
    ...
    test('openSettingsModal displays Guest Local Mode, Login button, Achievements card, version 1.4.3, and no bottom close button', () => {
        state.userAuthId = null;
        state.userEmail = null;
        ...
        expect(content.innerHTML).toContain('Version 1.4.3');
