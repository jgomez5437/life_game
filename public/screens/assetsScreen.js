    ...
    get('game-container').innerHTML = `
        <div class="fade-in flex flex-col h-full max-w-lg mx-auto">
            ...
            <div class="flex-1 overflow-y-auto pb-4">
                ...
                <!-- Go Shopping -->
                <div onclick="window.UI.showModal('Coming Soon', 'Shopping functionality will be added in a future update.')" class="bg-slate-800 p-4 rounded-xl border border-slate-700 mb-4 cursor-pointer hover:bg-slate-750 hover:border-blue-500/50 transition">
